const Menu = [
    {
      ...
      price: "12₹",
      description:
        "Maggi Masala Noodles contain: Noodles: Wheat Flour, Edible Vegetable Oil, Salt, Mineral (Calcium Carbonate), Guar Gum. Masala Tastemaker, Hydrolyzed Groundnut Protein, Mixed Spices 23.6% (Onion Powder, Coriander, Chili Powder, Turmeric, Garlic Powder, Cumin, Aniseed, Fenugreek, Ginger, Black Pepper, Clove, Nutmeg, Cardamom), Noodle PowderMaggi Masala Noodles are available in 5 packs of 70 g each, conveniently sized for on-the-go cooking!"
    },
